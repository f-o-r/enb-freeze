...
module.exports = require('enb/lib/build-flow').create()
    ...
    .methods({
         ...
         */
        processToken: function(parent, carrier, node, index) {
            ...
            if(match.length > 0 && excludes.indexOf(node.token) === -1) {
                return this.recursor(parent, carrier, node, match);
            } else {
                return {node: node, freezePairsList: [], match: match};
            }
        },
        ...
        processContent: function(parent, carrier, content) {
            return grammar
                .AST.flatten(
                    grammar.AST.fold(this._grammar.parse(content), grammar.helpers.fold.sameSiblings)
                )
                .map(function(node, index) {
                    return this.processToken(parent, carrier, node, index);
                }, this);
        },
        ...
        buildAndFreeze: function(parent, carrier, fullpath, token, concreteMatch, match) {
            return this
